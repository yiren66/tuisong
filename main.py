...
def send_message(to_user, access_token, region_name, weather, temp, wind_dir, note_ch, note_en, max_temp, min_temp,
                 sunrise, sunset, category, pm2p5, proposal, chp, sweet_word):
    ...
    data = {
        ...
        "data": {
            ...
            # 新增暖心情话字段
            "sweet_word": {
                "value": sweet_word if sweet_word else "愿你今天也开开心心～",
                "color": get_color()
            }
